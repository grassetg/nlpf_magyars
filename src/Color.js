...
export default function Color(props) {
    return (
        <div id="color">
            {props.more == "hiliteColor" && <MyPop more={props.more}/>}
            {props.more == "foreColor" && <MyPop more={props.more}/>}
        </div>
    );
}

function MyPop(props) {
    const changecolor=[
    ...
    for (var i = 0; i < changecolor.length; i++){
        items.push(<MyButton command={props.more} type={props.more} arg={changecolor[i]}/>);
    }
    return (
        <Popup
        ...
        >
            <div className="color-div">
                { props.more == "hiliteColor" && <p>Couleur de surlignage</p>}
                { props.more == "foreColor" && <p>Couleur de la police</p>}
                ...
                <div className="color-last">
                    ...
                    { props.more == "hiliteColor" && <p>Aucune couleur</p>}
                    { props.more == "foreColor" && <p>Automatique</p>}
                </div>
            </div>
        </Popup>
    );
